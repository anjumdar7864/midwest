...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutTiles: Schema.Attribute.Component<'tiles.banner-tiles', true>;
    certificates: Schema.Attribute.Component<'tiles.banner-tiles', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    ourCoreDescription: Schema.Attribute.Text;
    ourCoreTites: Schema.Attribute.Component<'tiles.banner-tiles', true>;
    ourCoreTitle: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.Component<'about-us.team', true>;
...
export interface ApiAppointmentPageAppointmentPage
  ...
  collectionName: 'appointment_pages';
  info: {
    displayName: 'AppointmentPage';
...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactTiles: Schema.Attribute.Component<'contact.contact-tiles', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Text;
    EmergencyInformation: Schema.Attribute.Component<
      'contact.emergency-block',
      false
    >;
    faqs: Schema.Attribute.Component<'contact.faqs', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    LogoDetails: Schema.Attribute.Text;
    phoneNumber: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    chooseUs: Schema.Attribute.Component<
      'home-banner-section.why-choose-us',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HomeBanner: Schema.Attribute.Component<
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    locationsHomeSection: Schema.Attribute.Component<
      'home-banner-section.location-section-home',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLogoLogo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    logoheader: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServicePageServicePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featureTiles: Schema.Attribute.Component<'services.feature-tiles', true>;
